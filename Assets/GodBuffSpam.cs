...
public class GodBuffSpam : MonoBehaviour
{
    ...
    public float enduranceTimer = 10f;
    private float timer = 0f;
    public ComboOrb comboScript;
    ...
    void Update()
    {
        if (comboScript.isAttacking == true)
        {
